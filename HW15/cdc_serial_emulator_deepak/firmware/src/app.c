...
int qq = 0, qint = 0;
int ii = 0;
float mLeftDC = 50.0, mRightDC = 50.0;
int mLeftTargetDC = 50, mRightTargetDC = 50;
float kp=1.0, ki=0.5;
...
//                OC1 is RB15 which is left
//                OC2 is RB8 which is right. 
                if(txFlag == 1) // When the entire number has been read
                {
                    if(qq <= 0) // COM is on the left side. Which means the right wheel should be faster. THerefore reduce left wheel speed
                    {
                    ...
                    else // ;left wheel should be faster.
                    {
                         LATAbits.LATA4 = 1;
                         mLeftDC = 100.0;
                         mRightDC = abs(qq);
...
//                    }
//
//                    if(mRightTargetDC > mRightDC)
//                    {
//                        mRightDC = mRightDC + 0.1;
//                    }
//                    else
//                    {
//                        mRightDC = mRightDC - 0.1;
//                    }
                    ...
                    OC1RS = (int)((abs(mLeftDC)/100.0)*(PERIOD + 1));
                    OC2RS = (int)((abs(mRightDC)/100.0)*(PERIOD + 1));
                    txFlag = 0;
                    
                }
                // make currDutyCycle slowly ramp towards the target duty cycle. 
